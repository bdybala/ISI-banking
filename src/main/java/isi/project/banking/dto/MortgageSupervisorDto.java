...
public class MortgageSupervisorDto {
	...
	public MortgageSupervisorDto(String pesel, String login, String password, String firstName, String lastName,
			String email, String nrTel, Date birthday, Set<RequestDto> requests, Set<MortgageLoan> mortgageLoans) {
		super();
		this.pesel = pesel;
		this.login = login;
		this.password = password;
