...
public class OfferCashLoanDto {
	...
	public OfferCashLoanDto(Integer id, String name, Double interest, String interestType, Double minSum, Double maxSum,
			Integer minInstallments, Integer maxInstallments, String author, Manager manager) {
		super();
		this.id = id;
		this.name = name;
