								...
								<form id="login-form" action=<c:url value="/login"/>
									...
									<div class="form-group">
										<input type="text" name="login" id="login" tabindex="1"
											class="form-control" placeholder="Identyfikator" value="">
									</div>
									<div class="form-group">
										<input type="password" name="password" id="password"
											tabindex="2" class="form-control" placeholder="Haslo">
									</div>
									<div class="form-group">
										<div class="row">
										...
										<div class="row">
											<div class="col-lg-12">
												<div class="text-center">
													<a href="recover_password.html" tabindex="5"
														class="forgot-password">Zapomniales hasla?</a>
												</div>
											</div>
										</div>
									</div>
