...
<body>
	...
	<p class="text-center">WNIOSEK O ZALOZENIA KONTA</p>
		<div class="form-group">
		  <label for="firstName">Imiona:</label>
		...
		<div class="form-group"> 
			<div class="col-sm-offset-5 col-sm-6">
				<button type="submit" class="btn btn-default" name="transferSubmitButton" onclick="registerSubmit"><a href=<c:url value="/register" />>Potwierdz</a></button>
			</div>
		</div>
	</div>
